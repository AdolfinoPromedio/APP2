...
public class Edition extends SpecificActions{ //Clase que modifica un libro.
    ...
    public void Cambio(List<Libros> libro, String carac, String new_dato, int nro_libro){ //Procedimiento que genera el cambio de un atributo de un libro del Arraylist.
