...
public class action extends find{ //Clase de acciones de la biblioteca virtual.
    ...
    public void agregarLibro(@NotNull List<libro> libro){ //Procedimiento que agrega un libro a la Arraylist dada.
    ...
    public void quitarLibro(@NotNull List<libro> libro){ //Procedimiento que quita un libro de la Arraylist dada.
    ...
    public void editarLibro(@NotNull List<libro> libro){ //Procedimiento que edita los atributos de un libro de la Arraylist dada.
        Cambio(libro);
    }
