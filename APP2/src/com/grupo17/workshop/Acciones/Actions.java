...
public class Actions{ //Clase de acciones de la biblioteca virtual.
    ...
    public void buscarLibro(@NotNull List<Libros> libro){ //Procedimiento que Buscará un libro e imprimirá sus datos.
        String nombre_libro = userinput.introducirLibro(); //Se introduce el título del libro solicitado.
    ...
    public void editarLibro(@NotNull List<Libros> libro){ //Procedimiento que edita los atributos de un libro de la Arraylist dada.
        ...
        String nombre_libro = userinput.introducirLibro(); //Se introduce título del libro.
        String carac = userinput.elegirCarac(); //Se introduce atributo a cambiar.
        String new_dato = userinput.introducirDato(); //Se introduce nuevo valor del atributo a cambiar.
        ...
        for(int i=0; i<=(libro.size()-1); i++){ //Ciclo que busca el libro por título.
            if (nombre_libro.equals(libro.get(i).getTitulo())==true){
                ...
                aux.Cambio(); //Se hace la modificación al atributo de la Arraylist.
    ...
    public void Alternativas(List<Libros> libro){ //Procedimiento que permite modificar, eliminar o añadir libros con base en las secciones, pisos y sedes.
        String accion = userinput.elegirAccion(); //Se ingresa la acción a hacer. Dependiendo de la acción, se hará lo correspondiente.
