...
public class SpecificActions { //Clase que cuenta con procedimientos básicos para el correcto y ágil funcionamiento de las demás clases del paquete.
    ...
    public String elegirCarac(){ //Función que solicita ingresar el atributo de un libro. Devuelve un String con el valor ingresado.
        Scanner input = new Scanner(System.in);  // Create a Scanner object
        System.out.println("Ingrese que dato desea modificar (Primera letra con mayusucula, resto con minusculas): ");
