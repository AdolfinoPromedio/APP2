...
public class Find extends Edition{ //Clase que modifica un libro.
    ...
    private static String atributo; //Atributo requerido.
    private static String filtro; //Filtro de búsqueda.

    public Find(List<Libros> libro, String atributo, String filtro) { //Setter de la clase.
        this.libro = libro;
        this.atributo = atributo;
        this.filtro = filtro;
    }*/

    public void Find(List<Libros> libro){ //Procedimiento que filtra la búsqueda de un atributo dentro del Arraylist.
