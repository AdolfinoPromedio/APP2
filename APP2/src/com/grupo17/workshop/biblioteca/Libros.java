...
public class Libros { //Clase que contiene la estructura de un libro junto con distintas funciones.
    //Atributos:
    ...
    public Libros(String titulo, String autor, int año, int estante_numero, String estante_seccion, int piso, String edificio, String sede) { //Setter.
        this.titulo = titulo;
        this.autor = autor;
        this.año = año;
